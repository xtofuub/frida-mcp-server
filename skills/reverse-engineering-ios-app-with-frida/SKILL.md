...
> - [references/bugbounty-playbooks.md](references/bugbounty-playbooks.md) — 10 end-to-end attack playbooks (recon, auth, IDOR, injection sweep, deep links, secrets, crypto, persistence, interception, anti-tamper)
> - [references/owasp-mobile-top10.md](references/owasp-mobile-top10.md) — M1–M10 mapped to specific tool chains
> - [references/masvs-checklist.md](references/masvs-checklist.md) — MASVS v2 controls with verification commands
> - [references/workflows.md](references/workflows.md) — original generic Frida workflows
> - [references/api-reference.md](references/api-reference.md) — raw Frida CLI / JS API reference for the escape-hatch cases
>
